...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h5 class="col-md-8">Table Pembelian Sparepart</h5>
                <div class="col-md-4 d-flex justify-content-end">
                    <a href="{{ route('sparepart-beli.create') }}" type="button" class="btn btn-primary">
            ...
            <div class="table-responsive text-nowrap">
                ...
                <table class="table table-responsive text-nowrap" id="table">
                    ...
                    <tr>
                        ...
                        <td>{{ $sparepart->tanggal_diterima }}</td>
                        ...
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('sparepart-beli.edit', $sparepart->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                            <form action="{{ route('sparepart-beli.delete', $sparepart->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
